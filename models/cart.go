...
type Cart struct {
	...
	GoodsSpecifitionNameValue string `json:"goods_specifition_name_value" xorm:"not null comment('规格属性组成的字符串，用来显示用') TEXT"`
	GoodsSpecifitionIds       string `json:"goods_specifition_ids" xorm:"not null default '' comment('product表对应的goods_specifition_ids') VARCHAR(60)"`
